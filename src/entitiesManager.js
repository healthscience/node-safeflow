...
*
*/
EntitiesManager.prototype.entityResultsReady = async function (shellID, ecsIN, rDUUID, computeFlag) {
...
*
*/
EntitiesManager.prototype.checkResults = function (shellID, uuidRData, computeFlag) {
  let dataPrint = {}
